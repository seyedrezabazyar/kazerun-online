    ...
    <footer class="bg-white border-t mt-20">
        <div class="container mx-auto px-4 py-8 md:py-12">
            <div class="footer-grid grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8">
                <div class="footer-section app-download-section">
                    <h3 class="font-bold text-gray-800 mb-3 text-lg md:text-base">دریافت اپلیکیشن</h3>
                    <div class="app-download-buttons flex flex-col md:flex-col space-y-2">
                        <a href="#"
                            class="flex items-center justify-center bg-black text-white px-3 py-2 md:px-4 md:py-2 rounded-lg hover:bg-gray-800 transition-colors text-sm">
                ...
                <div class="footer-section">
                    ...
                    <ul class="space-y-3 md:space-y-2 text-gray-600">
                        ...
                        <li><a href="#" class="hover:text-red-custom transition-colors block py-1">قوانین و مقررات</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div  style="margin: 0 auto; max-width: fit-content;">
            <div class="border-t pt-6 md:pt-8">
                <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                    <div
                        class="contact-info flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6 md:space-x-reverse text-sm text-gray-600">
                    ...
                    <div class="social-links flex items-center space-x-4 space-x-reverse">
                        <a href="#"
                            class="text-gray-600 hover:text-red-custom transition-colors p-2 hover:bg-gray-100 rounded-full">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path
                                    d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z" />
                            </svg>
                        </a>
                        <!-- سایر آیکون‌های شبکه‌های اجتماعی -->
                    </div>
                </div>
            </div>
        </div>
